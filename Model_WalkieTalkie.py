...
class DFNet:
    ...
    def build(input_shape, classes):
        ...
        kernel_size = ['None',5000,5000,5000,5000]
        conv_stride_size = ['None',1,1,1,1]
        pool_stride_size = ['None',4,4,4,4]
        pool_size = ['None',8,8,8,8]
        
        model.add(Conv1D(filters=filter_num[2], kernel_size=kernel_size[1],input_shape=input_shape,
        ...
        model.add(Conv1D(filters=filter_num[4], kernel_size=kernel_size[3],
